...
import { ILoginManager } from '@lib/platform_authenticator/ILoginManager';
...
export function serviceWorkerSupportStatus(): ServiceWorkerSupportStatus {
    return (window.navigator.serviceWorker == null || window.navigator.serviceWorker.controller == null) ? ServiceWorkerSupportStatus.NotSupported : ServiceWorkerSupportStatus.Supported;
}
